...
namespace Lab15 {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("UoMDbDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class UoMDbDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected UoMDbDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            UoMDbDataSet cln = ((UoMDbDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "UoMDbDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/UoMDbDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            UoMDbDataSet ds = new UoMDbDataSet();
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentsRow AddStudentsRow(int Id, string Name, string Course, System.DateTime DateOfBirth, bool Scholarship) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public bool Scholarship {
                get {
                    try {
                        return ((bool)(this[this.tableStudents.ScholarshipColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableStudents.ScholarshipColumn] = value;
                }
            }
            ...
            public bool IsScholarshipNull() {
                return this.IsNull(this.tableStudents.ScholarshipColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetScholarshipNull() {
                this[this.tableStudents.ScholarshipColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Lab15.UoMDbDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth)) AND ((@IsNull_Scholarship = 1 AND [Scholarship] IS NULL) OR ([Scholarship] = @Original_Scholarship)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Id], [Name], [Course], [DateOfBirth], [Scholarship" +
                "]) VALUES (@Id, @Name, @Course, @DateOfBirth, @Scholarship);\r\nSELECT Id, Name, C" +
                "ourse, DateOfBirth, Scholarship FROM Students WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Id] = @Id, [Name] = @Name, [Course] = @Course, [DateOfBirth] = @DateOfBirth, [Scholarship] = @Scholarship WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth)) AND ((@IsNull_Scholarship = 1 AND [Scholarship] IS NULL) OR ([Scholarship] = @Original_Scholarship)));
SELECT Id, Name, Course, DateOfBirth, Scholarship FROM Students WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab15.Properties.Settings.Default.UoMDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Course, DateOfBirth, Scholarship FROM dbo.Students";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Id, Name, Course, DateOfBirth, Scholarship\r\nFROM            Student" +
                "s\r\nWHERE        (Course = @course)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@course", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Course", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(UoMDbDataSet.StudentsDataTable dataTable) {
        ...
        public virtual UoMDbDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UoMDbDataSet.StudentsDataTable dataTable = new UoMDbDataSet.StudentsDataTable();
        ...
        public virtual int Search(UoMDbDataSet.StudentsDataTable dataTable, string course) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UoMDbDataSet.StudentsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UoMDbDataSet dataSet) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Course, global::System.Nullable<global::System.DateTime> Original_DateOfBirth, global::System.Nullable<bool> Original_Scholarship) {
            ...
            if ((Original_Scholarship.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((bool)(Original_Scholarship.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, string Name, string Course, global::System.Nullable<global::System.DateTime> DateOfBirth, global::System.Nullable<bool> Scholarship) {
            ...
            if ((Scholarship.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((bool)(Scholarship.Value));
            }
            else {
        ...
        public virtual int Update(int Id, string Name, string Course, global::System.Nullable<global::System.DateTime> DateOfBirth, global::System.Nullable<bool> Scholarship, int Original_Id, string Original_Name, string Original_Course, global::System.Nullable<global::System.DateTime> Original_DateOfBirth, global::System.Nullable<bool> Original_Scholarship) {
            ...
            if ((Scholarship.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((bool)(Scholarship.Value));
            }
            else {
            ...
            if ((Original_Scholarship.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((bool)(Original_Scholarship.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Course, global::System.Nullable<global::System.DateTime> DateOfBirth, global::System.Nullable<bool> Scholarship, int Original_Id, string Original_Name, string Original_Course, global::System.Nullable<global::System.DateTime> Original_DateOfBirth, global::System.Nullable<bool> Original_Scholarship) {
            return this.Update(Original_Id, Name, Course, DateOfBirth, Scholarship, Original_Id, Original_Name, Original_Course, Original_DateOfBirth, Original_Scholarship);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(UoMDbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._studentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(UoMDbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._studentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(UoMDbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._studentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(UoMDbDataSet dataSet) {
            if ((dataSet == null)) {
